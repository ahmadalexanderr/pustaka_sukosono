                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('auth/registration'); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="Username (tanpa Spasi)" value="<?= set_value('name'); ?>">
                        ...
                        <hr>
                        <div class="text-center">
                           <a class="small" href="<?= base_url('auth/name_registration'); ?>">Buat akun dengan username</a>
                        </div>
                        <div class="text-center">
